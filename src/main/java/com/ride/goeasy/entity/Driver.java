...
>>>>>>> 4d96f0ce0cb6920c270ad32d8b44efedb4575d87
	...
	public String toString() {
		return "Driver{" + "id=" + id + ", dname='" + dname + '\'' + ", licNo='" + licNo + '\'' + ", upiId='" + upiId
				+ '\'' + ", dstatus='" + dstatus + '\'' + ", age=" + age + ", mobNo=" + mobNo + ", gender='" + gender
				+ '\'' + ", mailId='" + mailId + '\'' + ", vehicle="
				+ (vehicle != null ? vehicle.getVehicleName() : null) + '}';
	}
}
